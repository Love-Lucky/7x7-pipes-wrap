#!/usr/bin/env python3
"""Chạy test12 và lưu kết quả vào output/test12_result.txt"""
import tracemalloc
import time
from main import PipeState, astar, count_open_ends

with open('test_inputs/test12_hard_six.txt', 'r') as f:
    puzzle_str = f.read()
...
output = []
output.append("="*80)
output.append("TEST CASE: test12_hard_six.txt")
output.append("="*80)
output.append("")
...
text = "\n".join(output)
print(text)
with open('output/test12_result.txt', 'w', encoding='utf-8') as f:
    f.write(text)
print("\n\n✅ Đã lưu kết quả vào: output/test12_result.txt")
